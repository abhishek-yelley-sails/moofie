...
const pages = [{ name: "About", link: "/about" }];
...
export default function MainNavigation() {
    ...
    return (
        <AppBar position="sticky" sx={{ background: "rgb(41, 61, 69)" }}>
            <nav>
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                            {pages.map((page) => (
                                <NavLink
                                    ...
                                    style={{ marginRight: "2px", marginLeft: "2px", display: 'block', textDecoration: "none" }}
                                >
                                    {page.name}
                                </NavLink>
                            ))}
